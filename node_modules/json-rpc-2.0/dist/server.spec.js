...
mocha_1.describe("JSONRPCServer", function () {
    ...
    [{}, "", "invalid JSON"].forEach(function (invalidJSON) {
        mocha_1.describe("receiving an invalid JSON (" + invalidJSON + ")", function () {
            ...
            mocha_1.it("should respond an error", function () {
                chai_1.expect(response.error.code).to.equal(_1.JSONRPCErrorCode.ParseError);
            });
        });
    });
    [
        ...
        mocha_1.describe("receiving an invalid request (" + JSON.stringify(invalidRequest) + ")", function () {
            ...
            mocha_1.it("should respond an error", function () {
                chai_1.expect(response.error.code).to.equal(_1.JSONRPCErrorCode.InvalidRequest);
            });
        });
    });
    ...
    mocha_1.describe("having an async method", function () {
        var methodName;
        var receivedRequest;
        ...
        mocha_1.describe("using middleware", function () {
            ...
            mocha_1.describe("requesting", function () {
                ...
                mocha_1.it("should call the middleware", function () {
                    chai_1.expect(middlewareCalled).to.be.true;
                });
                mocha_1.it("should receive a request", function () {
                    chai_1.expect(receivedRequest).to.deep.equal(givenRequest);
                });
                mocha_1.it("should received server params", function () {
                    chai_1.expect(receivedServerParams).to.deep.equal(givenServerParams);
                });
                mocha_1.it("should not return from the next middleware yet", function () {
                    chai_1.expect(nextReturned).to.be.false;
                });
                mocha_1.describe("finishing the request", function () {
                    mocha_1.beforeEach(function () {
                        returnFromMethod();
                        return consumeAllEvents();
                    });
                    mocha_1.it("should return from the next middleware", function () {
                        chai_1.expect(nextReturned).to.be.true;
                    });
                    mocha_1.it("should return a response", function () {
                        chai_1.expect(actualResponse).to.deep.equal(returnedResponse);
                    });
                });
            });
            mocha_1.describe("using another middleware", function () {
                ...
                mocha_1.describe("requesting", function () {
                    ...
                    mocha_1.it("should call the first middleware", function () {
                        chai_1.expect(middlewareCalled).to.be.true;
                    });
                    mocha_1.it("should call the second middleware", function () {
                        chai_1.expect(secondMiddlewareCalled).to.be.true;
                    });
                });
            });
        });
        mocha_1.describe("using a middleware that changes request and server params", function () {
            var changedParams;
            ...
            mocha_1.describe("requesting", function () {
                ...
                mocha_1.it("should change the request", function () {
                    var expectedRequest = __assign(__assign({}, givenRequest), { params: changedParams });
                    chai_1.expect(receivedRequest).to.deep.equal(expectedRequest);
                });
                mocha_1.it("should change the server params", function () {
                    chai_1.expect(receivedServerParams).to.deep.equal(changedServerParams);
                });
            });
        });
        mocha_1.describe("using a middleware that changes response", function () {
            var changedResponse;
            mocha_1.beforeEach(function () {
                server.applyMiddleware(function (next, request, serverParams) {
            ...
            mocha_1.describe("requesting", function () {
                ...
                mocha_1.it("should return the changed response", function () {
                    chai_1.expect(actualResponse).to.deep.equal(changedResponse);
                });
            });
        });
        mocha_1.describe("using middleware that catches exception", function () {
            mocha_1.beforeEach(function () {
                server.applyMiddleware(function (next, request, serverParams) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                error_1 = _a.sent();
                                return [2 /*return*/, _1.createJSONRPCErrorResponse(request.id, error_1.code || _1.JSONRPCErrorCode.InternalError, error_1.message)];
            ...
            mocha_1.describe("throwing", function () {
                ...
                mocha_1.it("should catch the exception on middleware", function () {
                    var expected = _1.createJSONRPCErrorResponse(0, error.code, error.message);
                    chai_1.expect(actualResponse).to.deep.equal(expected);
                });
            });
        });
        mocha_1.describe("using multiple middleware", function () {
            var count;
            var first;
            var second;
            var third;
            ...
            mocha_1.it("should call middleware in the applied order", function () {
                chai_1.expect([first, second, third]).to.deep.equal([1, 2, 3]);
            });
        });
    });
});
