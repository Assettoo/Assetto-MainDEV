...
async function setupInputCell(txSkeleton, inputCell, fromInfo, {
  ...
  if (firstIndex !== -1) {
    ...
    const firstIndexWitness = txSkeleton.get("witnesses").get(firstIndex); // If never prepared witness of this lock script before, should using fromInfo(MultisigScript) to update witness
