...
class Keystore {
  ...
  save(dir, {
    ...
    const path = _path.default.join(dir, name);
  ...
  static create(extendedPrivateKey, password, options = {}) {
    ...
    const derivedKey = _crypto.default.scryptSync(password, salt, kdfparams.dklen, Keystore.scryptOptions(kdfparams));
  ...
  derivedKey(password) {
    ...
    return _crypto.default.scryptSync(password, Buffer.from(kdfparams.salt, "hex"), kdfparams.dklen, Keystore.scryptOptions(kdfparams));
  }
