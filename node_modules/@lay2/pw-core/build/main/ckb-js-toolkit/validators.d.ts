...
export namespace validators {
    ...
    export { ValidateOutPoint };
    export { ValidateCellInput };
    export { ValidateCellOutput };
    export { ValidateCellDep };
    export { ValidateRawTransaction };
    export { ValidateTransaction };
    export { ValidateRawHeader };
    export { ValidateHeader };
    export { ValidateUncleBlock };
    export { ValidateBlock };
    export { ValidateCellbaseWitness };
    export { ValidateWitnessArgs };
}
